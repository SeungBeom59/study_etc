            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="/todo/list" method="get">
                        ...
                        <div class="mb-3">
                            <input type="checkbox" name="finished" ${pageRquestDTO.finished?"checked" : ""}>완료여부
                        </div>
                        <div class="mb-3">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="/todo/read?tno=${dto.tno}&${pageRequestDTO.link}"
                                           class="decoration-none" data-tno="${dto.tno}">
                        ...
                        <ul class="pagination flex-wrap">
                            ...
                            <c:forEach begin="${responseDTO.start}" end="${responseDTO.end}" var="num">
                                <li class="page-item ${responseDTO.page == num? "active":""}">
                                    <a class="page-link" href="/todo/list?page=${num}" data-num="${num}">${num}</a>
                                </li>
                            </c:forEach>
